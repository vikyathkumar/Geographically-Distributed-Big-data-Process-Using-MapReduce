...
import javaanpr.imageanalysis.normalSnapshot;
...
public class FrameMain extends javax.swing.JFrame {
    ...
    public class RecognizeThread extends Thread {
        ...
        public void run() {
            ...
            try {
                recognizedText = Main.systemLogic.recognize(this.parentFrame.normal);
            } catch (Exception ex) {
    ...
    public class LoadImageThread extends Thread {
        ...
        public void run() {
            try {
                this.parentFrame.normal = new normalSnapshot(url);
                this.parentFrame.panelnormalContent = this.parentFrame.normal.duplicate().getBi();
                this.parentFrame.panelnormalContent = Photo.linearResizeBi(this.parentFrame.panelnormalContent,
                        this.parentFrame.panelnormal.getWidth(),
                        this.parentFrame.panelnormal.getHeight());
                this.parentFrame.panelnormal.paint(this.parentFrame.panelnormal.getGraphics());
    ...
    normalSnapshot normal;
    BufferedImage panelnormalContent;
    ...
    private void initComponents() {
        ...
        panelnormal = new JPanel() {
            ...
            public void paint(Graphics g) {
                super.paint(g);
                g.drawImage(panelnormalContent,0,0,null);
            }
        };
        ...
        panelnormal.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        org.jdesktop.layout.GroupLayout panelnormalLayout = new org.jdesktop.layout.GroupLayout(panelnormal);
        panelnormal.setLayout(panelnormalLayout);
        panelnormalLayout.setHorizontalGroup(
            panelnormalLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    ...
                    .add(org.jdesktop.layout.GroupLayout.LEADING, panelnormal, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(panelnormal, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(bottomLine))
        );
        pack();
...
// TODO add your handling code here:
    ...
    private void recognizeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_recognizeButtonActionPerformed
        ...
        // namiesto tohto urobime thread plate = Main.systemLogic.recognize(this.normal);
        // thread code start
