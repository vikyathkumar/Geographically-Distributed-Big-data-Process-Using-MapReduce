        ...
        function getLineGraph() {
            FusionCharts.ready(function () {
                var revenueChart = new FusionCharts({
                    ...
                    "dataSource": {
                        "chart": {
                            "caption": "Identifying road blockage due to any natural disaster",
                            "subCaption": "The states of all resources for different frameworks",
                            "xAxisName": "Framework scheduler",
                            "yAxisName": "MapReduce cluster",
                            "lineThickness": "2",
        ...
        function getDoughnutGraph(){
            FusionCharts.ready(function () {
                var revenueChart = new FusionCharts({
                    ...
                    "dataSource": {
                        "chart": {
                            "caption": "Resource Allocation Mechanisms for Geo-Distributed Systems",
                            "subCaption": "The states of all resources for different frameworks",
                            "xAxisName": "Framework scheduler",
                            "yAxisName": "MapReduce cluster",
                            "paletteColors": "#0075c2,#1aaf5d,#f2c500,#f45b00,#8e0000",
    ...
    <section>
      ...
      <nav>
        ...
        <article class="homeDetail">
            <h1 class="homePage">A Survey on Geographically Distributed
Big-Data Processing using MapReduce</h1>
        </article>
